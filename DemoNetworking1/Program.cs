namespace DemoNetworking1
{
	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			WriteLine($"Host: {info.Host}"); WriteLine($"Port: {info.Port}");
			...
			WriteLine($"IsAbsoluteUri: {relative.IsAbsoluteUri}"); WriteLine($"RelativeUri: {relative.ToString()}");
			ReadLine();
		}
	}
}
